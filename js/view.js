...
function showText(text) {
	var messages = {
		...
		'pausedAndroid': "<div class='centeredHeader unselectable'>游戏暂停</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:300px;font-size:16px;'><a href = 'https://www.lyf233.cn/' target='_blank' hallo!</a></div>",
		'pausediOS': "<div class='centeredHeader unselectable'>游戏暂停</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:300px;font-size:16px;'><a href = 'https://www.lyf233.cn/' target='_blank'>hallo</a></div>",
		'pausedOther': "<div class='centeredHeader unselectable'>游戏暂停</div><div class='unselectable centeredSubHeader' style='margin-top:10px;position:absolute;left:50%;margin-left:-190px;max-width:380px;font-size:18px;'><a href = 'https://www.lyf233.cn/' target='_blank'>hallo</a></div>",
